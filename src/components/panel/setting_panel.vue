 ...
 * @LastEditTime: 2022-03-29 17:47:13
-->
<template>
  <div class="panel_outer">
    <div class="store_title">系统设置</div>
    <div class="button_group">
      <div class="store_button" @click="saveGameAction()">保存</div>
      <div class="store_button" @click="loadGameAction()">加载</div>
      <div class="store_button" @click="clearGameAction()">清空</div>
...
import {saveGame,
    loadGame,clearGame} from "../../libs/games/game_load";
...
function saveGameAction(){
    saveGame(global_my,global_bag,global_bag_goods,sys_log) 
}
function loadGameAction(){
    loadGame(global_my,global_bag,global_bag_goods,sys_log,global_equi) 
}
function clearGameAction(){
  clearGame()
}
// saveGame(global_my,global_bag,global_bag_goods,sys_log)
// function saveMy(my) {
